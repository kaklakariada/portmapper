...
/**
 * This class implements an output stream that appends to a list and allows
 * listeners to register for written lines.
 */
public class LogMessageOutputStream extends OutputStream {
	...
	/**
	 * Creates a new {@link LogMessageOutputStream}. At creation time, no
	 * listener is registered, so that all added text is stored in a buffer.
	 */
